...
from api.agent.email_agent import EmailAgent, RankedArticleDetail, EmailDigestResponse
from api.agent.curator_agent import CuratorAgent
from api.profiles.user_profile import USER_PROFILE
from api.database.repository import Repository
from api.services.email import send_email, digest_to_html
...
def send_digest_email(hours: int = 24, top_n: int = 10, email: list = None) -> dict:
    try:
